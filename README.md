...
`--target` accepts `superblock`, `inode`, `dirent`, `xattr`, `chunk`, `compression`, `cross`, or `all`.
...
location, and checksum repair. Generated libFuzzer corpora and artifacts under
