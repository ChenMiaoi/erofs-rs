...
Manifest parsing rejects non-actionable classifications, signatures that do
not match the classification prefix, and duplicate paths so each bundle role
points at a distinct attachment.
